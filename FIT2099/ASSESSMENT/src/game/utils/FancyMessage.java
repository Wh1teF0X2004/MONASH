...
public class FancyMessage {
    ...
    /**
     * Message to display when the game starts
     */
    ...
    /**
     * Message to display when the player died
     */
    ...
    /**
     * Message to display when the demigod has died
     */
    public static String DEMIGOD_FELL =
            "\n" +
            "                                                                                                                                                             \n" +
            "                                                                                                                                                             \n" +
