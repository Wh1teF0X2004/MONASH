...
ALTER TABLE customer
    ADD CONSTRAINT chk_cust_lvl CHECK ( cust_level IN ( 'b', 'g', 's' ) );
...
ALTER TABLE product
    ADD CONSTRAINT product_category FOREIGN KEY ( pcat_id )
